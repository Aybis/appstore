...
export const useDownload = (app: App | null): DownloadState => {
  ...
  const start = useCallback(async () => {
    ...
    try {
      ...
      // Recorded once the handoff is made, not once the OS confirms the
      // install — neither platform reports that back to us. This is the
      // strongest signal available for "My Apps".
